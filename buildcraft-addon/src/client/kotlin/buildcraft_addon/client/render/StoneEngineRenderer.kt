...
class StoneEngineRenderer(ctx: BlockEntityRendererFactory.Context) :
    BlockEntityRenderer<StoneEngineBlockEntity> {
    ...
    private fun ensureSprites() {
        ...
        backSprite = sprite("block/engine/stone/back")
        sideSprite = sprite("block/engine/stone/side")
    ...
    private fun getTrunkSprite(stage: PowerStage): Sprite = when (stage) {
        ...
        PowerStage.BLACK -> trunkBlue // fallback
    }

    override fun render(
        entity: StoneEngineBlockEntity,
        tickDelta: Float,
    ...
    override fun rendersOutsideBoundingBox(entity: StoneEngineBlockEntity): Boolean = true
}
