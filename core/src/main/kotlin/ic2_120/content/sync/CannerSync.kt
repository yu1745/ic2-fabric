...
class CannerSync(
    ...
    var leftFluidAmount by schema.int("LeftFluidAmount", default = 0)
    var leftFluidCapacity by schema.int("LeftFluidCapacity", default = 8000)
    var leftFluidRawId by schema.int("LeftFluidRawId", default = -1)
    var rightFluidAmount by schema.int("RightFluidAmount", default = 0)
    var rightFluidCapacity by schema.int("RightFluidCapacity", default = 8000)
