...
class SteamKineticGeneratorBlock : DirectionalMachineBlock() {
    ...
    override fun createBlockEntity(pos: BlockPos, state: BlockState): BlockEntity =
        SteamKineticGeneratorBlockEntity(pos, state)
    ...
    companion object {
        ...
        fun generateRecipes(exporter: RecipeExporter) {
            ...
            if (steelCasing != net.minecraft.item.Items.AIR && copperBoiler != net.minecraft.item.Items.AIR && emptyCell != net.minecraft.item.Items.AIR) {
                ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, SteamKineticGeneratorBlock::class.item(), 1)
                    .pattern("CBC")
                    .pattern("IEI")
                    .pattern("CIC")
                    .input('C', steelCasing)
                    ...
                    .input('I', ironIngot)
                    .input('E', emptyCell)
                    .criterion(hasItem(steelCasing), conditionsFromItem(steelCasing))
                    .offerTo(exporter, SteamKineticGeneratorBlock::class.id())
            }
        }
    }
}
