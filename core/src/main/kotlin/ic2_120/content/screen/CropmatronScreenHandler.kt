...
class CropmatronScreenHandler(
    ...
    override fun quickMove(player: PlayerEntity, index: Int): ItemStack {
        ...
        when {
            ...
            index in SLOT_FERTILIZER_INDEX_START..SLOT_FERTILIZER_INDEX_END -> {
                if (!insertItem(inSlot, PLAYER_INV_START, HOTBAR_END + 1, true)) return ItemStack.EMPTY
            }
            ...
            index in PLAYER_INV_START..HOTBAR_END -> {
                val fertilizerTargets = (SLOT_FERTILIZER_INDEX_START..SLOT_FERTILIZER_INDEX_END).map {
                    SlotTarget(slots[it], FERTILIZER_SLOT_SPEC)
                }
                ...
                val moved = SlotMoveHelper.insertIntoTargets(
                    ...
                    ) + fertilizerTargets + upgradeTargets
                )
    ...
    companion object {
        ...
        private val FERTILIZER_SLOT_SPEC = SlotSpec(canInsert = { stack -> stack.item == Fertilizer::class.instance() })
