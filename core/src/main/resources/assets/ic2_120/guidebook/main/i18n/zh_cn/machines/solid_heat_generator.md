...
支持的燃料为**煤炭**、**木炭**和**焦炭**。本机使用这些燃料的熔炉燃烧时间除以 4 来计算 tick：

| 燃料 | 熔炉 tick | 燃烧时长 | 累计 HU |
|------|-----------|----------|---------|
| 煤炭 | 1,600 | 400 tick（20 秒） | 8,000 HU |
| 木炭 | 1,600 | 400 tick（20 秒） | 8,000 HU |
| 焦炭 | 3,200 | 800 tick（40 秒） | 16,000 HU |

焦炭的燃烧时间是煤炭或木炭的两倍，是单位数量下能效最高的燃料。
