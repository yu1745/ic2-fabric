...
| 物品 | 等级 | 最大 EU | 说明 |
|------|:---:|---:|-------|
| <ItemLink id="ic2_120:single_use_battery" /> | 1 | 可配置 | 一次性电池，在任何普通电池槽放电，耗尽后销毁。 |
| <ItemLink id="ic2_120:re_battery" /> | 1 | 可配置 | 基础可充电电池，是早期工具最可靠的移动 EU 来源。 |
| <ItemLink id="ic2_120:advanced_re_battery" /> | 2 | 可配置 | 高容量可充电电池，能让中期电动工具免去频繁充电。 |

默认值可在模组的 `Ic2Config` 中调整；具体容量与传输速率请查看对应版本配置文件。
