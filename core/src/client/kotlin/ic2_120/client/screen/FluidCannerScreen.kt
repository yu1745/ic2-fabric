...
class FluidCannerScreen(
        ...
        if (relX in TANK_X until TANK_X + TANK_W &&
            ...
            context.drawTooltip(
                ...
                listOf(
                    ...
                    Text.literal("${EnergyFormatUtils.formatEu(fluidAmount)} / ${EnergyFormatUtils.formatEu(fluidCapacity)} mB")
                ),
                mouseX, mouseY
            )
        }
    ...
    companion object {
        private val TEXTURE = Identifier.of("ic2", "textures/gui/guifluidcanner.png")
