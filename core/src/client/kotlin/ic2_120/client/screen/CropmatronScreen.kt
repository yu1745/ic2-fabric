...
class CropmatronScreen(
    ...
    override fun render(context: DrawContext, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        val waterFraction = (waterAmount.toFloat() / CropmatronSync.WATER_TANK_CAPACITY_MB).coerceIn(0f, 1f)
        val weedExFraction = (weedExAmount.toFloat() / CropmatronSync.WEED_EX_TANK_CAPACITY_MB).coerceIn(0f, 1f)
