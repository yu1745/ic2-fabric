...
class FluidHeatExchangerBlock : MachineBlock() {
    ...
    override fun <T : BlockEntity> getTicker(
        ...
        else validateTicker(type, FluidHeatExchangerBlockEntity::class.type()){ w, p, s, be ->
    ...
    companion object {
        ...
        fun generateRecipes(exporter: RecipeExporter) {
            ...
            if (casing != Items.AIR && emptyCell != Items.AIR && heat != Items.AIR) {
                ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, FluidHeatExchangerBlock::class.item(), 1)
                    .pattern("CEC")
                    .pattern("EHE")
                    .pattern("CEC")
                    .input('C', casing)
                    ...
                    .offerTo(exporter, FluidHeatExchangerBlock::class.id())
            }
        }
    }
}
