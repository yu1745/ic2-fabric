...
从分叉点 `c5e247c` 到 main HEAD 共 **21 个 commit**，**15 个已同步，6 个待同步**。
...
| 18 | `d981e518` | feat: 所有管道和泵附件tooltip显示流量（按秒计算） | ❌ | 新增 |
| 19 | `1cbc87e8` | fix: 管道tooltip使用国际化字符串 | ❌ | 新增 |
| 20 | `4219b84e` | feat: 区块加载器改为GUI控制区块加载范围 | ❌ | 新增 |
| 21 | `53988ef3` | feat: 扳手右键改为直接设置方块朝向 | ❌ | 新增 |
